        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button
              ...
              size="mini"
              @click="handleAdd"
              v-hasPermi="['student:profile:add']"
            >新增</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              :disabled="single"
              @click="handleUpdate"
              v-hasPermi="['student:profile:edit']"
            >修改</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              :disabled="multiple"
              @click="handleDelete"
              v-hasPermi="['student:profile:remove']"
            >停用</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              size="mini"
              @click="handleImport"
              v-hasPermi="['student:profile:import']"
            >导入</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              size="mini"
              @click="handleExport"
              v-hasPermi="['student:profile:export']"
            >导出</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="学员昵称" prop="nickName">
              <el-input v-model="form.nickName" placeholder="请输入学员昵称" maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="生日" prop="birthday">
              <el-date-picker v-model="form.birthday" type="date" clearable value-format="yyyy-MM-dd" placeholder="请选择用户生日"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
<script>
import { listUser, getUser, delUser, addUser, updateUser, resetUserPwd, changeUserStatus, deptTreeSelect,unBindWx,getProvince,getCityByParentId } from "@/api/student/profile";
...
export default {
    ...
    return {
      ...
      rules: {
        ...
        password: [
          ...
          { min: 5, max: 20, message: '学员密码长度必须介于 5 和 20 之间', trigger: 'blur' }
        ],
        email: [
          {
            type: "email",
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$modal.confirm('确认要"' + text + '""' + row.userName + '"学员吗？').then(function() {
    ...
    handleResetPwd(row) {
      this.$prompt('请输入"' + row.userName + '"的新密码', "提示", {
        ...
        inputPattern: /^.{5,20}$/,
        inputErrorMessage: "学员密码长度必须介于 5 和 20 之间"
      }).then(({ value }) => {

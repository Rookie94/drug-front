...
import delete1Img from '@/assets/images/delete1.png'
import delete2Img from '@/assets/images/delete2.png'
...
export default {
  ...
  // submitSelectUser(nikeNamelist)方法传参一个默认接收用户昵称数组   
  // submitSelectUser(peopleList,nikeNamelist)方法传参两个则是接收用户昵称数组和用户账号数组
        ...
        .peopleCard {
            ...
            .avatarBox {
                ...
                .peopleDeleteBtn {
                    ...
                    height:20px;
                    // border-radius: 50%;
                    background: url({{delete1Img}}) no-repeat;
                ...
                .peopleDeleteBtn:hover {
                    ...
                    height:20px;
                    // border-radius: 50%;
                    background: url({{delete2Img}}) no-repeat;
                    background-size:100% 100%;
                    transition: .2s;
                }
        }
